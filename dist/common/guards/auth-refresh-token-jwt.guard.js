...
var authRefreshTokenJwtGuard = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, userId, isBannedToken;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, auth_repository_1.AuthRepository.checkIsRefreshTokenBanned(token)];
            case 2:
                isBannedToken = _a.sent();
                if (isBannedToken) {
                    res.sendStatus(constants_1.STATUS_CODES.UNAUTHORIZED);
                    return [2 /*return*/];
                }
...
exports.authRefreshTokenJwtGuard = authRefreshTokenJwtGuard;
//# sourceMappingURL=auth-refresh-token-jwt.guard.js.map