...
blogsRouter.get.apply(blogsRouter, __spreadArray(__spreadArray(['/:blogId/posts'], blogs_validation_1.blogsValidation.pagination, false), [blogs_controller_1.BlogsController.getPostsByBlogId], false));
blogsRouter.post.apply(blogsRouter, __spreadArray(__spreadArray(['/:blogId/posts', auth_guard_1.authGuard], blogs_validation_1.blogsValidation.newPost, false), [blogs_controller_1.BlogsController.postPostByBlogId], false));
