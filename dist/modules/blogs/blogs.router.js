...
blogsRouter.post.apply(blogsRouter, __spreadArray(__spreadArray(['/',
    auth_basic_guard_1.authBasicGuard], blogs_validation_1.blogsValidation.inputBody, false), [input_validation_middleware_1.inputValidationMiddleware,
    blogs_controller_1.BlogsController.postBlog], false));
...
blogsRouter.post.apply(blogsRouter, __spreadArray(__spreadArray(['/:blogId/posts',
    auth_basic_guard_1.authBasicGuard], blogs_validation_1.blogsValidation.newPost, false), [input_validation_middleware_1.inputValidationMiddleware,
...
blogsRouter.put.apply(blogsRouter, __spreadArray(__spreadArray(__spreadArray(['/:id',
    auth_basic_guard_1.authBasicGuard], blogs_validation_1.blogsValidation.update, false), blogs_validation_1.blogsValidation.inputBody, false), [input_validation_middleware_1.inputValidationMiddleware,
    blogs_controller_1.BlogsController.putBlogById], false));
blogsRouter.delete('/:id', auth_basic_guard_1.authBasicGuard, blogs_controller_1.BlogsController.deleteBlogById);
