...
var PostsController = /** @class */ (function () {
    ...
    PostsController.getPostById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var post;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PostsController.putPostById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var postWithUpdate, postUpdateResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        postWithUpdate = req.body;
                        return [4 /*yield*/, posts_service_1.PostsService.updatePostById(req.params.id, postWithUpdate)];
                    case 1:
    ...
    PostsController.deletePostById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var isPostDeleted;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, posts_service_1.PostsService.deleteBLogById(req.params.id)];
                    case 1:
