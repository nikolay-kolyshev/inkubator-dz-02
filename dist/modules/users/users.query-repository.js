...
var UsersQueryRepository = /** @class */ (function () {
    ...
    UsersQueryRepository.findUserSchemaByConfirmationCode = function (code) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, collections_1.usersCollection.findOne({ emailConfirmationCode: code })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
